  ...
  return (
    <div className="page-workshop" style={{ paddingTop: 'var(--space-12)', paddingBottom: 'var(--space-20)' }}>
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto var(--space-10) auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 'var(--space-8)', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '0.9rem', color: 'var(--color-text-inverse-muted)', margin: 0 }}>
          ...
          <div className="form-card glass-card" style={{ padding: 'var(--space-4)', borderRadius: 'var(--radius-xl)' }}>
            ...
            <div style={{ minHeight: '620px', position: 'relative', background: '#fff', borderRadius: 'var(--radius-md)', overflow: 'hidden' }}>
              {iframeLoading && (
